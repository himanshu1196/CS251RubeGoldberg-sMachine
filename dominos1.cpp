  ...
  
   {
     ...
     */
    {
      ...
      */
      ...
      wedgefd2.density = 10.0f;
      wedgefd2.friction = 0.0f;
      wedgefd2.restitution = 0.0f;
      b2BodyDef wedgebd2;
      wedgebd2.position.Set(0.0f, -20.0f);
       ...
       */   
      b2PolygonShape shape2;
      shape2.SetAsBox(8.0f, 0.2f);
      b2BodyDef bd22;
      bd22.position.Set(0.0f, -19.0f);
      bd22.type = b2_dynamicBody;
      b2Body* body = m_world->CreateBody(&bd22);
      b2FixtureDef *fd2 = new b2FixtureDef;
      fd2->density = 1.f;
      fd2->shape = new b2PolygonShape;
      fd2->shape = &shape2;
      ...
      b2RevoluteJointDef jd;
      b2Vec2 anchor2;
      anchor2.Set(0.0f, -19.0f);
      jd.Initialize(sbody2, body, anchor2);
      m_world->CreateJoint(&jd);
  }
	/*!/////////////////////////////////////////////////////////////// 
